                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('category.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full bg-gray-900 border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Electronic" required autofocus />
